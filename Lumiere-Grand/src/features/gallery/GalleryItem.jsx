  ...
  return (
    ...
    >
      <OptimizedImage
        ...
        responsiveWidths={[420, 640, 840, 1200]}
        className="h-56"
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 translate-y-4 px-5 pb-5 opacity-0 transition-all duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100">
